...
HD_PWD='D:/demo2/autoPUF/autoPUF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MOD_HW.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MOD_HW.tcl -notrace
